      ...
      try {
        ...
        if (employee) {
          setFormData({
            ...
            level1Approver: employee.level1Approver?._id || employee.level1Approver || "",
            level2Approver: employee.level2Approver?._id || employee.level2Approver || "",
            level3Approver: employee.level3Approver?._id || employee.level3Approver || "",
            level4Approver: employee.level4Approver?._id || employee.level4Approver || "",
            level5Approver: employee.level5Approver?._id || employee.level5Approver || "",
          });
        }
      } catch (err) {
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
              <Autocomplete
                ...
                value={
                  employees.find((emp) => emp._id === formData.level1Approver) ||
                  null
                }
            ...
            <Grid item xs={12}>
              <Autocomplete
                ...
                value={
                  employees.find((emp) => emp._id === formData.level2Approver) ||
                  null
                }
                onChange={(event, newValue) => {
                  setFormData({
            ...
            <Grid item xs={12}>
              <Autocomplete
                ...
                value={
                  employees.find((emp) => emp._id === formData.level3Approver) ||
                  null
                }
                onChange={(event, newValue) => {
                  setFormData({
            ...
            <Grid item xs={12}>
              <Autocomplete
                ...
                value={
                  employees.find((emp) => emp._id === formData.level4Approver) ||
                  null
                }
                onChange={(event, newValue) => {
                  setFormData({
            ...
            <Grid item xs={12}>
              <Autocomplete
                ...
                value={
                  employees.find((emp) => emp._id === formData.level5Approver) ||
                  null
                }
                onChange={(event, newValue) => {
                  setFormData({
