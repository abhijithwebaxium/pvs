...
import { colorSchemes, typography, shadows, shape, neutralColorSchemes } from './themePrimitives';
...
function AppTheme({ children, disableCustomTheme, themeComponents }) {
  ...
  const theme = React.useMemo(() => {
    ...
    const activeColorSchemes = selectedColorScheme === 'neutral' ? neutralColorSchemes : colorSchemes;
